...
metric_io_table = [
    dict(
        query = str('gtp_tickets_sold:cumulative_v2 > 0'),
        metric_to_record = 'gtp_tickets_sold:rebase',
        group_name = "rebased gtp_tickets_sold at " + str(rebase_time)
    ),
    dict(
        query = str('gtp_completed_orders_total_value:cumulative_v2 > 0'),
